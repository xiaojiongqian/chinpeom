  ...
  <div v-if="isDevelopment" class="fixed bottom-4 right-4 z-50">
    ...
    >
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <button class="text-gray-400 hover:text-gray-600 text-xl" @click="showPanel = false">
          ×
        </button>
      </div>
      ...
      <div class="mb-2">
        <button class="px-2 py-1 bg-red-500 text-white text-xs rounded mr-2" @click="clearAllCache">
          清除缓存
        </button>
        <button
